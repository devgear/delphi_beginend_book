...
uses
  ...
  PlatformDefaultStyleActnCtrls, RpCon, RpConDS, RpConBDE, RpBase, RpSystem,
  RpDefine, RpRave;
...
type
  ...
  TMainForm = class(TForm)
    ...
    procedure Report_ActionExecute(Sender: TObject);
  private
  end;
var
  MainForm: TMainForm;
...
procedure TMainForm.Report_ActionExecute(Sender: TObject);
begin
